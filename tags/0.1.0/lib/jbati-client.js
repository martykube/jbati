/***********************************************************************  
 *  jBati JavaScript ORM Framework - Version 0.1.0
...
(function() {
	...
	JBati.Client.SqlMapClient.prototype = {
		...
		//
		// Parameters:
		//	callback - The function that is called with the result set.
		// 	statementId - The name of the SQL statement.
		// 	parameterObject  - The object that provides parameters for the SQL statement.
		//
		...
		//	Error - If more than one row is selected
		//
		...
		// multiple object instances. The parameter object is generally 
		// used to supply the input data for the WHERE clause parameter(s).
		//
		// Parameters:
		// 	statementId - The name of the SQL statement.
		...
		//
		// Returns:
		// 	An Array of objects populated by the result set.
		//
		queryForList: function(statementId, parameterObject) {
		  return __jbati_proxy(this.sqlMapConfigName, 'queryForList', statementId, parameterObject);
		},

		// method: queryForListAsync
		// Executes a mapped SQL SELECT statement asynchronously that returns data to populate 
		// multiple object instances. The parameter object is generally 
		// used to supply the input data for the WHERE clause parameter(s).
		//
		// Parameters:
		...
		//
		// Returns:
		// 	An Array of objectspopulated by the result set.
		//
		queryForListAsync: function(callback, statementId, parameterObject) {
		  return __jbati_proxyAsync(callback, this.sqlMapConfigName, 'queryForList', statementId, parameterObject);
		},
...
// Used by jBati for blocking server callbacks.
//
// function: __jbati_proxyAsync
// Used by jBati for asynchronous server callbacks.
//
// variable: JBati
